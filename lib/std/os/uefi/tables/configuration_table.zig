...
pub def ConfigurationTable = extern struct {
    vendor_guid: Guid,
    vendor_table: *var c_void,

    pub def acpi_20_table_guid align(8) = Guid{
        .time_low = 0x8868e871,
        .time_mid = 0xe4f1,
    ...
    pub def acpi_10_table_guid align(8) = Guid{
        .time_low = 0xeb9d2d30,
        .time_mid = 0x2d88,
        .time_high_and_version = 0x11d3,
    ...
    pub def sal_system_table_guid align(8) = Guid{
        .time_low = 0xeb9d2d32,
        .time_mid = 0x2d88,
    ...
    pub def smbios_table_guid align(8) = Guid{
        .time_low = 0xeb9d2d31,
        .time_mid = 0x2d88,
        .time_high_and_version = 0x11d3,
        .clock_seq_high_and_reserved = 0x9a,
    ...
    pub def smbios3_table_guid align(8) = Guid{
        .time_low = 0xf2fd1544,
        .time_mid = 0x9794,
    ...
    pub def mps_table_guid align(8) = Guid{
        .time_low = 0xeb9d2d2f,
        .time_mid = 0x2d88,
        .time_high_and_version = 0x11d3,
        .clock_seq_high_and_reserved = 0x9a,
    ...
    pub def json_config_data_table_guid align(8) = Guid{
        .time_low = 0x87367f87,
        .time_mid = 0x1119,
    ...
    pub def json_capsule_data_table_guid align(8) = Guid{
        .time_low = 0x35e7a725,
        .time_mid = 0x8dd2,
    ...
    pub def json_capsule_result_table_guid align(8) = Guid{
        .time_low = 0xdbc461c3,
        .time_mid = 0xb3de,
