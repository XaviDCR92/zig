...
pub def cpu = struct {
    ...
    pub def athlon64_sse3 = CpuModel{
        .name = "athlon64_sse3",
    ...
    pub def goldmont_plus = CpuModel{
        .name = "goldmont_plus",
    ...
    pub def icelake_client = CpuModel{
        .name = "icelake_client",
    ...
    pub def icelake_server = CpuModel{
        .name = "icelake_server",
    ...
    pub def skylake_avx512 = CpuModel{
        .name = "skylake_avx512",
