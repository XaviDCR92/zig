...
pub def cpu = struct {
    ...
    pub def cortex_m0plus = CpuModel{
        .name = "cortex_m0plus",
    ...
    pub def strongarm1100 = CpuModel{
        .name = "strongarm1100",
    ...
    pub def strongarm1110 = CpuModel{
        .name = "strongarm1110",
