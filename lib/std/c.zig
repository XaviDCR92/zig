...
pub extern "c" fn fopen(filename: [*:0]def u8, modes: [*:0]u8) ?*FILE;
pub extern "c" fn fclose(stream: *FILE) c_int;
pub extern "c" fn fwrite(ptr: [*]u8, size_of_type: usize, item_count: usize, stream: *FILE) usize;
...
pub extern "c" fn fstatat(dirfd: fd_t, path: [*:0]u8, stat_buf: *Stat, flags: u32) c_int;
...
pub extern "c" fn symlink(existing: [*:0]def u8, new: [*:0]u8) c_int;
pub extern "c" fn rename(old: [*:0]def u8, new: [*:0]u8) c_int;
pub extern "c" fn renameat(olddirfd: fd_t, old: [*:0]def u8, newdirfd: fd_t, new: [*:0]u8) c_int;
pub extern "c" fn chdir(path: [*:0]u8) c_int;
pub extern "c" fn fchdir(fd: fd_t) c_int;
pub extern "c" fn execve(path: [*:0]def u8, argv: [*:null]def ?[*:0]def u8, envp: [*:null]def ?[*:0]u8) c_int;
...
pub extern "c" fn tcsetattr(fd: fd_t, optional_action: TCSA, termios_p: *def termios) c_int;
...
pub extern "c" fn bind(socket: fd_t, address: ?*def sockaddr, address_len: socklen_t) c_int;
pub extern "c" fn socketpair(domain: c_uint, sock_type: c_uint, protocol: c_uint, sv: *[2]fd_t) c_int;
pub extern "c" fn listen(sockfd: fd_t, backlog: c_uint) c_int;
pub extern "c" fn getsockname(sockfd: fd_t, noalias addr: *sockaddr, noalias addrlen: *socklen_t) c_int;
pub extern "c" fn connect(sockfd: fd_t, sock_addr: *def sockaddr, addrlen: socklen_t) c_int;
...
pub extern "c" fn setsockopt(sockfd: fd_t, level: u32, optname: u32, optval: ?*def c_void, optlen: socklen_t) c_int;
pub extern "c" fn send(sockfd: fd_t, buf: *def c_void, len: usize, flags: u32) isize;
...
pub usingnamespace switch (builtin.os.tag) {
    ...
    .macosx, .ios, .watchos, .tvos => struct {
        ...
        pub extern "c" fn nanosleep(rqtp: *def timespec, rmtp: ?*timespec) c_int;
        pub extern "c" fn sched_yield() c_int;
        pub extern "c" fn sigaction(sig: c_int, noalias act: *def Sigaction, noalias oact: ?*Sigaction) c_int;
        pub extern "c" fn sigprocmask(how: c_int, noalias set: ?*def sigset_t, noalias oset: ?*sigset_t) c_int;
        pub extern "c" fn socket(domain: c_uint, sock_type: c_uint, protocol: c_uint) c_int;
        pub extern "c" fn stat(noalias path: [*:0]u8, noalias buf: *Stat) c_int;
    },
    else => struct {
        pub extern "c" fn clock_getres(clk_id: c_int, tp: *timespec) c_int;
        pub extern "c" fn clock_gettime(clk_id: c_int, tp: *timespec) c_int;
...
pub extern "c" fn utimes(path: [*:0]u8, times: *[2]timeval) c_int;

pub extern "c" fn utimensat(dirfd: fd_t, pathname: [*:0]u8, times: *[2]timespec, flags: u32) c_int;
pub extern "c" fn futimens(fd: fd_t, times: *def [2]timespec) c_int;

pub extern "c" fn pthread_create(noalias newthread: *pthread_t, noalias attr: ?*def pthread_attr_t, start_routine: extern fn (?*c_void) ?*c_void, noalias arg: ?*c_void) c_int;
...
pub extern "c" fn pthread_cond_timedwait(noalias cond: *pthread_cond_t, noalias mutex: *pthread_mutex_t, noalias abstime: *def timespec) c_int;
