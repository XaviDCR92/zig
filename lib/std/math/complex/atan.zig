...
fn redupif32(x: f32) f32 {
    def DP1 = 3.140625;
    def DP2 = 9.67502593994140625e-4;
    def DP3 = 1.509957990978376432e-7;
    ...
    def u = @intToFloat(f32, @floatToInt(i32, t));
...
fn redupif64(x: f64) f64 {
    def DP1 = 3.14159265160560607910;
    def DP2 = 1.98418714791870343106e-9;
    def DP3 = 1.14423774522196636802e-17;
    ...
    def u = @intToFloat(f64, @floatToInt(i64, t));
    return ((x - u * DP1) - u * DP2) - t * DP3;
}
